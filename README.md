...
1. This repo is the official implementation of [A Geometric Perspective towards Neural Calibration via Sensitivity Decomposition](https://arxiv.org/abs/2110.14577) (*tian21gsd*). The pape is accpted at [NeurIPS 2021](https://nips.cc/Conferences/2021/ScheduleMultitrack?event=26546). as a spotlight paper.
2. We **reimplememented** [Exploring Covariate and Concept Shift for Out-of-Distribution Detection](https://arxiv.org/abs/2110.15231) (*tian21explore*) and include it in the code base as well. The paper is accepted at [NeurIPS 2021 workshop on Distribution Shift](https://sites.google.com/view/distshift2021). 
